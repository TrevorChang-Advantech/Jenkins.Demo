    ...
    stages {
        ...
        stage('Publish') {
            steps {
                ...
                dir("${env.WORKING_DIR}") {
                    bat 'dotnet publish Jenkins.Demo.Web/Jenkins.Demo.Web.csproj /p:PublishProfile=Jenkins.Demo.Web/Properties/PublishProfiles/LocalIIS.pubxml /p:PublishUrl=D:\IIS\Jenkins.Demo.Web'
                }
            }
        }
    }
